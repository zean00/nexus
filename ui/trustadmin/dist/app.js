...
function App() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "trust-admin", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "grid", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "panel", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Policies" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { onSubmit: submitPolicy, className: "form", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { placeholder: "agent profile id", value: draft.agent_profile_id, onChange: (e) => setDraft({ ...draft, agent_profile_id: e.target.value }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked: draft.require_linked_identity_for_execution, onChange: (e) => setDraft({ ...draft, require_linked_identity_for_execution: e.target.checked }) }),
            " Require link for execution"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked: draft.require_linked_identity_for_approval, onChange: (e) => setDraft({ ...draft, require_linked_identity_for_approval: e.target.checked }) }),
            " Require link for approval"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked: draft.require_recent_step_up_for_approval, onChange: (e) => setDraft({ ...draft, require_recent_step_up_for_approval: e.target.checked }) }),
            " Require recent step-up"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { placeholder: "allowed approval channels, comma-separated", value: draft.allowed_approval_channels, onChange: (e) => setDraft({ ...draft, allowed_approval_channels: e.target.value }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "submit", children: "Save policy" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { children: JSON.stringify(policies, null, 2) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "panel", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Users and links" }),
        users.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "user", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: entry.user.primary_email }),
          entry.user.primary_phone ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            entry.user.primary_phone,
            " ",
            entry.user.primary_phone_verified ? "(verified)" : "(unverified)"
          ] }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: (entry.linked_identities ?? []).map((identity) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
            identity.channel_type,
            ":",
            identity.channel_user_id,
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => revoke(identity.channel_type, identity.channel_user_id), children: "Revoke" })
          ] }, `${identity.channel_type}:${identity.channel_user_id}`)) }),
          entry.link_hints ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { children: JSON.stringify(entry.link_hints, null, 2) }) : null
        ] }, entry.user.id))
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "panel", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Recent trust events" }),
