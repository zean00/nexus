...
- WhatsApp Web groups can be ignored or routed only when the bot is natively mentioned, with optional group JID allow/block lists, while Nexus keeps the full group transcript in session history
